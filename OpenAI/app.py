...
st.markdown("<h1 style='color:black;'>GenAI App - AI Code Reviewer</h1>", unsafe_allow_html=True)

# User input section
st.markdown("<h2 style='color:black;'>Enter Your Python Code</h2>", unsafe_allow_html=True)
prompt = st.text_area("Enter your Python code here:", height=200)

# Button to trigger code review
if st.button("Review the Code"):
    st.markdown("<h2 style='color:black;'>Code Reviewer</h2>", unsafe_allow_html=True)
